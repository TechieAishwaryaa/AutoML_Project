...
#https://github.com/hamzzi0097/OpenSource_AutoML_Project
...
def dataset_stat(dataset_df):	
	#To-Do: Implement this function
    feature_num = len(dataset_df.columns) - 1
    class1_num = dataset_df["target"].sum()
    class0_num = len(dataset_df["target"].index) - class1_num
    return feature_num, class0_num, class1_num
